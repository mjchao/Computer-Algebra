 ...
 */
public class StableLinkedList<E> 
{
	...
	public int getSize()
	{
		return this.m_numberOfUserDefinedLinks;
	}
	...
	public void replaceNextElement( E newElement) {
		this.m_currentLink.getNextLink().setElement( newElement );
	}
	...
	{
		if ( this.m_currentLink == this.m_lastLinkInList ) {
			this.m_lastLinkInList = this.m_previousLink;
		}
	 ...
	 * 
	 * @param newElement			new element to take the place of the current element		
	 */
	public void replaceCurrentElement( E newElement ) {
		this.m_currentLink.setElement( newElement );
	}
	...
	public void removeAll()
	{
		...
		this.m_numberOfUserDefinedLinks = 0;
	}
